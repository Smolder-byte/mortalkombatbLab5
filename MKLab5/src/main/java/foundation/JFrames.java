...
/**
 * Класс для управления графическим интерфейсом игры Mortal Kombat.
 * Отвечает за отображение главного меню, боевого окна, диалогов и обновление элементов интерфейса.
 */
public class JFrames extends javax.swing.JFrame {
    ...
    private String selectedItemButtonName = "";

    /**
     * Конструктор, инициализирующий интерфейс и данные игры.
     */
    public JFrames() {
        initComponents();
        initializeGameData();
    ...
    /**
     * Инициализирует данные игры, загружает результаты и создаёт предметы.
     */
    private void initializeGameData() {
        ...
        game.updateLeaderboardTable(jTable1);
    ...
    /**
     * Добавляет радиокнопки предметов в группу.
     */
    ...
    /**
     * Обновляет отображение характеристик игрока в интерфейсе.
     */
    ...
    /**
     * Сгенерированный благодаря формам код
     */
    ...
    private void initComponents() {
        ...
        weakenLabel = new javax.swing.JLabel();
        ...
        ImageIcon playerIcon = new ImageIcon(getClass().getResource("/Pictures/Kitana.png"));
        Image scaledPlayer = playerIcon.getImage().getScaledInstance(200, 275, Image.SCALE_SMOOTH);
        jLabel2.setIcon(new ImageIcon(scaledPlayer));
        jLabel2.setMaximumSize(new java.awt.Dimension(200, 275));
        jLabel2.setMinimumSize(new java.awt.Dimension(200, 275));
        jLabel2.setPreferredSize(new java.awt.Dimension(200, 275));
        ...
        weakenLabel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);

        jButton12.setText("Weaken");
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(jLabel29, javax.swing.GroupLayout.PREFERRED_SIZE, 283, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                                .addGap(0, 0, Short.MAX_VALUE)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(weakenLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 267, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGroup(jPanel2Layout.createSequentialGroup()
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(weakenLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        ImageIcon originalLogo = new ImageIcon(getClass().getResource("/Pictures/MK.png"));
        Image scaledLogo = originalLogo.getImage().getScaledInstance(70, 70, Image.SCALE_SMOOTH);
        jLabel3.setIcon(new ImageIcon(scaledLogo));

        jLabel33.setFont(new java.awt.Font("Comic Sans MS", 0, 12));
        jLabel33.setText("Количество локаций:");
     ...
     * Инициализирует новую игру с указанным количеством локаций.
     */
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
            try {
            int locations = Integer.parseInt(jTextField2.getText());
            game.setTotalLocations(Math.max(1, locations));
        ...
        human = game.createNewHuman(jProgressBar1);
        game.setHuman(human);
        enemy = game.createNewEnemy(jLabel4, jLabel5, jLabel10, jLabel13, jProgressBar2);

        game.textUpdater.updateNewRoundText(human, enemy, jProgressBar1, jProgressBar2,
                jLabel17, jLabel16, jLabel6, jLabel19, jLabel12, jLabel13, jLabel9,
                jLabel26, jLabel27, game.fight.currentTurn, items, jRadioButton1, jRadioButton2, jRadioButton3, weakenLabel);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        game.fight.performAttack( human, enemy, 1, jLabel13, jLabel12, jDialog1, 
    ...
    /**
     * Обрабатывает нажатие кнопки "Защититься".
     */
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        game.fight.performAttack( human, enemy, 0, jLabel13, jLabel12, jDialog1, 
                jLabel18, game.action, jProgressBar1, jProgressBar2, jDialog2, 
                jDialog4, jFrame1, game.getResults(), jLabel20, jLabel24, 
                jLabel26, jLabel29, jLabel27, items, jRadioButton3, game, weakenLabel);
    ...
    /**
     * Обрабатывает нажатие кнопки "Дальше" в диалоге окончания раунда.
     */
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
    enemy = game.fight.startNewRound(human, jLabel4, jProgressBar1, jProgressBar2, 
            jLabel5, jLabel10, jLabel13, game.action, game);

    // Обновляем отображение здоровья игрока (оно уже восстановлено в EndRound)
    ...
    /**
     * Обрабатывает нажатие кнопки "Закончить игру" в диалоге победы.
     */
    ...
    /**
     * Обрабатывает нажатие кнопки "Закрыть" в таблице рекордов.
     */
    ...
    /**
     * Обрабатывает нажатие кнопки "Посмотреть таблицу результатов".
     */
    ...
    /**
     * Обрабатывает нажатие кнопки "Закончить игру" в диалоге без топ-10.
     */
    ...
    /**
     * Обрабатывает нажатие кнопки "Использовать" для предметов.
     */
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        if(jRadioButton1.isSelected()){
            selectedItemButtonName="jRadioButton1";
        }
        if(jRadioButton2.isSelected()){
            selectedItemButtonName="jRadioButton2";
        }
        if(jRadioButton3.isSelected()){
            selectedItemButtonName="jRadioButton3";
        }
        game.action.useItem(human, items, selectedItemButtonName, jDialog6, jDialog5);
        game.action.updateHealthBar(human, jProgressBar1);
        jLabel12.setText(human.getHealth() + "/" + human.getMaxHealth());
        game.textUpdater.updateInventoryText(items, jRadioButton1, jRadioButton2, jRadioButton3);
    }//GEN-LAST:event_jButton9ActionPerformed

    /**
     * Обрабатывает нажатие кнопки "Предметы".
     */
    ...
    /**
     * Обрабатывает нажатие кнопки "ОК" в диалоге ошибки использования предмета.
     */
    ...
    /**
     * Обрабатывает нажатие кнопки "Увеличить урон" в диалоге повышения уровня.
     */
    ...
    /**
     * Обрабатывает нажатие кнопки "Увеличить хп" в диалоге повышения уровня.
     */
    ...
    /**
     * Обрабатывает нажатие кнопки "Weaken".
     */
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
    game.fight.performAttack(human, enemy, 2, jLabel13, jLabel12, jDialog1, 
                jLabel18, game.action, jProgressBar1, jProgressBar2, jDialog2, 
                jDialog4, jFrame1, game.getResults(), jLabel20, jLabel24, 
                jLabel26, jLabel29, jLabel27, items, jRadioButton3, game, weakenLabel);
...
//}
    ...
    private javax.swing.JLabel weakenLabel;
